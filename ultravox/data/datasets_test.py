...
def test_dataset_config():
    config = types.DatasetConfig(
        ...
        path="mock_path",
        splits=[
            types.DatasetSplitConfig(name="clean", num_samples=5000, split_type=types.DatasetSplit.TRAIN),
            types.DatasetSplitConfig(name="other", num_samples=10000, split_type=types.DatasetSplit.TRAIN),
...
def test_generic_dataset():
    config = types.DatasetConfig(
        name="fake_dataset",
        path="fake_path",
        splits=[types.DatasetSplitConfig(name="fake", num_samples=5, split_type=types.DatasetSplit.TRAIN)],
    )
...
def test_generic_dataset_length_mismatch():
    ...
    config = types.DatasetConfig(
        name="fake_dataset",
        path="fake_path",
        splits=[types.DatasetSplitConfig(name="fake", num_samples=10, split_type=types.DatasetSplit.TRAIN)],
    )
    ds = FakeGenericDataset(5, config)
    assert len(ds) == 10
