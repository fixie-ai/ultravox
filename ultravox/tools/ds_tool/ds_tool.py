...
from ultravox.tools.ds_tool.tasks import asr_task
from ultravox.tools.ds_tool.tasks import audio_mix_task
from ultravox.tools.ds_tool.tasks import audio_split_task
from ultravox.tools.ds_tool.tasks import augment_task
...
from ultravox.tools.ds_tool.tasks import voice_ds_gen_task
...
DS_TOOL_TASKS: Dict[str, Type[ds_commons.DSToolTask]] = {
    ...
    "asr": asr_task.AsrTask,
    "dedup": dedup_task.DeduplicationTask,
    "audiosplit": audio_split_task.AudioSplitTask,
    "augment": augment_task.AugmentationTask,
    "audiomix": audio_mix_task.AudioMixTask,
    "voice_ds_gen": voice_ds_gen_task.VoiceDSGenerationTask,
}
...
#   just ds_tool audiosplit -d huseinzol05/musan-mirror -u fixie-ai/musan-segments -a wav -i __key__
#   just ds_tool augment -d fixie-ai/common_voice_17_0 -S en -s train -n 20000 -u fixie-ai/common_voice_17_0_random_gain -A random_gain
#   just ds_tool audiomix -d fixie-ai/common_voice_17_0 -S en -s train -n 20000 -u fixie-ai/common_voice_17_0-musan -m huseinzol05/musan-mirror -maudio wav
...
class DatasetToolArgs:
    ...
    num_shards: Optional[int] = simple_parsing.field(default=16, alias="-N")
    private: bool = simple_parsing.field(default=True)
